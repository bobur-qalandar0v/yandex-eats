...
const DeliverIcon = (props) => (
  <svg
    ...
    fill="none"
    viewBox="0 0 24 24"
    className="UiKitUiKitIcon_xl UiKitImgIcon UiKitUiKitIcon_root UiKitImgIcon"
    role="img"
    aria-hidden="true"
    {...props}
    width={18}
